...
const GOOGLE_CLIENT_ID = import.meta.env.VITE||"YOUR_GOOGLE_CLIENT_ID_HERE"; 
        ...
        {loading ? (
          ...
          <div key={idx} className="ref-item">
            ...
            <div className="ref-pattern">
              {item.pattern_regex || "Complex / Mixed"}
            </div>
          </div>
        ))}
      </div>
...
// --- 2. AUTH COMPONENT (Unchanged logic, cleaner integration) ---
